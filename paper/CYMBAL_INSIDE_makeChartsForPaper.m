...
for i=1:length(fileNames)
    ...
    %saveas(fig, fullfile(pathToFiguresBoundaryConditions, sprintf('%s mics nodes xy', fileName)), 'eps');
    ...
    %saveas(fig, fullfile(pathToFiguresBoundaryConditions, sprintf('%s nodes eq srcs xy plane', fileName)), 'eps');
    ...
    %saveas(fig, fullfile(pathToFiguresBoundaryConditions, sprintf('%s nodes eq srcs mics xz plane',  fileName)), 'eps');
    ...
    %saveas(fig, fullfile(pathToFiguresBoundaryConditions, sprintf('%s nodes eq srcs mics yz plane', fileName)), 'eps');
