...
pathToFigures = fullfile(folder.data, scenario, folder.figures, folder.boundaryConditions, boundaryConditions, folder.reconstruction, folder.DESM);
mkdir(pathToFigures);

%% SETUP PATHS
pathToReconstruction = fullfile(folder.data, scenario, folder.boundaryConditions, boundaryConditions, folder.reconstruction, folder.DESM);
